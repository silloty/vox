...
<page style="font-size: 10pt">
	...
	<table style="width: 50%;border: solid 3px #5544DD">
		<tr>
			...
			<td style="width: 40%; text-align: center;"><img src="../_fpdf/tutoriel/logo.png" alt="" ><br><i>légende</i></td>
			<td style="width: 30%; text-align: right; ">Texte à droite</td>
		</tr>
	</table>
	<br>
	<b>Dans un texte :</b><br>
	texte à la suite d'une image, <img src="../_fpdf/tutoriel/logo.png" alt="" style="height: 10mm">
