	...
	<table cellspacing="0" style="width: 100%; text-align: center; font-size: 14px">
		<tr>
			...
			<td style="width: 25%; color: #444444;">
				<img style="width: 100%;" src="../_fpdf/tutoriel/logo.png" alt="Logo fpdf"><br>
				RELATION CLIENT
			</td>
		</tr>
	</table>
...
?>
	...
	<br>
	Cette reprise concerne la quantité et les matériels dont la référence figure sur le document de reprise joint.<br>
