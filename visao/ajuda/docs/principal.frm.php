...
<table width="100%" height="163" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="29" bgcolor="#FFFFFF"><strong>&nbsp;<span class="style22">&nbsp;</span><span class="subtitulo">1</span></strong><span class="subtitulo"> Tela de Login</span></td>
  </tr>
  <tr>
          ...
          <table width="101%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <th width="93%" bgcolor="#F3F8F1" scope="col"><div align="justify">
                <p class="texto">Voc&ecirc; est&aacute; na central de ajuda do sistema de ouvidoria VOX. Aqui voc&ecirc; encontrar&aacute; solu&ccedil;&otilde;es e informa&ccedil;&otilde;es sobre a utiliza&ccedil;&atilde;o deste sistema como: </p>
                <ul>
                  <li class="texto">Visualizar manifesta&ccedil;&otilde;es  ;</li>
                  <li class="texto">Encaminhar manifesta&ccedil;&otilde;es;</li>
                  <li class="texto">Acompanhar o andamento destas;</li>
                  <li class="texto">Gera&ccedil;&atilde;o de relat&oacute;rios;</li>
                  <li class="texto">Cadastro, altera&ccedil;&atilde;o e exclus&atilde;o de dados no sistema. </li>
                  </ul>
                <p class="texto">Para realizar estas a&ccedil;&otilde;es o usu&aacute;rio dever&aacute; entrar com um login e uma senha que foram pr&eacute;-cadastrados no sistema . </p>
                <p class="texto">A tela abaixo &eacute; respons&aacute;vel pela autentica&ccedil;&atilde;o de usu&aacute;rios. </p>
                <p><img src="img_ajuda/TelaLogin.jpg" width="416" height="247"></p>
                <p class="texto">1 - LOGIN E SENHA: Nestes campos voc&ecirc; dever&aacute; informar o login e a senha que foi pr&eacute;-cadastrado no sistema. Caso n&atilde;o tenha um login e senha procure o administrador (silas.silva@ifmg.edu.br) </p>
                <p class="texto">2 - CONFIRMAR: Clicar no bot&atilde;o para enviar os dados e autenticar o usu&aacute;rio. </p>
                <p class="texto">&nbsp;</p>
              </div></th>
