...
<table width="100%" height="163" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="29" bgcolor="#FFFFFF"><strong>&nbsp;<span class="style22">&nbsp;</span><span class="subtitulo">3</span></strong><span class="subtitulo"> Tela de Manifesta&ccedil;&otilde;es Abertas </span></td>
  </tr>
  <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <th width="93%" bgcolor="#F3F8F1" scope="col"><div align="justify">
                <p class="texto">Nesta tela voc&ecirc; poder&aacute; visualizar todas as manifesta&ccedil;&otilde;es rec&eacute;m-encaminhadas pelos manifestantes ou que ainda n&atilde;o foram repassadas aos departamentos. </p>
                <p class="texto">Estas manifesta&ccedil;&otilde;es est&atilde;o apresentadas em uma tabela com apenas algumas informa&ccedil;&otilde;es mais relevantes como o c&oacute;digo, o assunto, a clientela, o tipo de manifesta&ccedil;&atilde;o, a forma de identifica&ccedil;&atilde;o, e a data da manifesta&ccedil;&atilde;o. </p>
                <p class="texto"><img src="img_ajuda/TelaAbertas.jpg" width="645" height="369"></p>
                ...
                <p class="texto">4 - BOT&Atilde;O VOLTAR - Clique em voltar para retornar a tela administrativa. </p>
                <p class="texto">&nbsp;</p>
              </div></th>
