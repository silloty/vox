...
<table width="100%" height="163" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="29" bgcolor="#FFFFFF"><strong>&nbsp;<span class="style22">&nbsp;</span></strong><span class="subtitulo">13 Tela de Status - Visualiza&ccedil;&atilde;o e Cadastro </span></td>
  </tr>
  <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <th width="93%" bgcolor="#F3F8F1" scope="col"><div align="justify">
                <p class="texto">Nesta tela voc&ecirc; poder&aacute; visualizar todos os tipos de status cadastrados no sistema. </p>
                <p class="texto"><img src="img_ajuda/TelaStatus.jpg" width="693" height="260" border="0"></p>
                <p class="texto">1 - ALTERAR - Como descrito em vermelho pressione enter sobre a op&ccedil;&atilde;o desejada para alterar algum dado. Voc&ecirc; ser&aacute; redirecionado para a tela da figura logo abaixo (Figura 2) </p>
                <p class="texto">2 - NOVO - Para cadastrar um status clique em novo que ser&aacute; redirecionado para a tela da figura logo abaixo(Figura 2).</p>
                <p class="texto">3 - EXCLUIR - Para deletar um status clique em excluir. Os status aberto, fechado e em andamento n&atilde;o podem ser exclu&iacute;dos. </p>
                ...
                <p class="texto"><img src="img_ajuda/TelaStatusAlteracao.jpg" width="445" height="306"></p>
                ...
                <p class="texto">2 - CAMPOS - Preencha os campos para realizar a opera&ccedil;&atilde;o.</p>
