...
<table width="100%" height="163" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="29" bgcolor="#FFFFFF"><strong>&nbsp;</strong><span class="subtitulo">12 Tela de Clientela - Visualiza&ccedil;&atilde;o e Cadastro </span></td>
  </tr>
  <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <th width="93%" bgcolor="#F3F8F1" scope="col"><div align="justify">
                <p class="texto">Nesta tela voc&ecirc; poder&aacute; visualizar todos os tipos de clientela cadastrados no sistema. </p>
                <p class="texto"><img src="img_ajuda/TelaClientela.jpg" width="698" height="252" border="0"></p>
                ...
                <p class="texto">2 - NOVO - Para cadastrar clientelas clique em novo que ser&aacute; redirecionado para a tela da figura logo abaixo(Figura 2).</p>
                ...
                <p class="texto">* - EXCLUIR - Para excluir um tipo de clientela procure o administrador (silas@cefetbambui.edu.br).</p>
                <p class="texto"><strong><em>Figura 2 (abaixo) </em></strong></p>
                <p class="texto"><img src="img_ajuda/TelaClientelaAlteracao.jpg" width="442" height="307"></p>
                ...
                <p class="texto">2 - CAMPOS - Preencha o campo para realizar a opera&ccedil;&atilde;o.</p>
