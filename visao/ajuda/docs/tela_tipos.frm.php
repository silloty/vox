...
<table width="100%" height="163" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="29" bgcolor="#FFFFFF"><strong>&nbsp;<span class="style22">11 </span></strong><span class="subtitulo">Tela de Tipos - Visualiza&ccedil;&atilde;o e Cadastro </span></td>
  </tr>
  <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <th width="93%" bgcolor="#F3F8F1" scope="col"><div align="justify">
                <p class="texto">Nesta tela voc&ecirc; poder&aacute; visualizar todos os tipos de manifesta&ccedil;&otilde;es cadastradas no sistema. </p>
                <p class="texto"><img src="img_ajuda/TelaDepartamentos.jpg" width="694" height="272" border="0"></p>
                <p class="texto">1 - ALTERAR - Como descrito em vermelho pressione enter sobre a op&ccedil;&atilde;o desejada para alterar algum dado do departamento. Voc&ecirc; ser&aacute; redirecionado para a tela da figura logo abaixo (Figura 2) </p>
                <p class="texto">2 - NOVO - Para cadastrar um tipo de manifesta&ccedil;&atilde;o clique em novo que ser&aacute; redirecionado para a tela da figura logo abaixo(Figura 2).</p>
                <p class="texto">3 - N&Uacute;MERO DE P&Aacute;GINAS- Neste local est&aacute; descrito a numera&ccedil;&atilde;o da p&aacute;gina em que se encontra assim como a quantidade de p&aacute;ginas existentes.</p>
                <p class="texto">* - EXCLUIR - Para excluir um tipo de manifesta&ccedil;&atilde;o procure o administrador (silas@cefetbambui.edu.br) </p>
                <p class="texto"><strong><em>Figura 2 (abaixo) </em></strong></p>
                <p class="texto"><img src="img_ajuda/TelaTiposAlteracao.jpg" width="438" height="308"></p>
                ...
                <p class="texto">2 - CAMPO - Preencha o campo para realizar a opera&ccedil;&atilde;o.</p>
