...
<table width="100%" height="163" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="29" bgcolor="#FFFFFF"><strong>&nbsp;<span class="style22">&nbsp;</span></strong><span class="subtitulo">6 Tela de Detalhes das Manifesta&ccedil;&otilde;es em Andamento </span></td>
  </tr>
  <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <th width="93%" bgcolor="#F3F8F1" scope="col"><div align="justify">
                <p class="texto">Nesta tela voc&ecirc; poder&aacute; visualizar todos os dados referente a manifesta&ccedil;&atilde;o em andamento que voc&ecirc; escolheu. </p>
                <p class="texto">Tamb&eacute;m pode ser visualizado ao final da p&aacute;gina uma tabela com as respostas dos departamento, a data de envio e a data de resposta. </p>
                <p class="texto"><img src="img_ajuda/TelaAndamentoDetalhes.jpg" width="627" height="493" border="1"></p>
                <p class="texto">1 - &Iacute;CONE INFORMA&Ccedil;&Atilde;O- Passe o mouse sobre &iacute;cone para obter informa&ccedil;&otilde;es da legenda de cores.</p>
                <p class="texto">2 - ENCAMINHAR - Caso a manifesta&ccedil;&atilde;o precise ser passada a mais algum departamento voc&ecirc;  dever&aacute; escolher outro departamento na caixa de sele&ccedil;&atilde;o (departamento) e clicar em encaminhar. A manifesta&ccedil;&atilde;o ser&aacute; encaminhada ao departamento atrav&eacute;s de um email e continuar&aacute; com o status em andamento.</p>
                <p class="texto">3 - FINALIZAR - Caso a manifesta&ccedil;&atilde;o tenha uma resposta definitiva do(s) departamento(s) a ouvidora poder&aacute; finaliz&aacute;-la redigindo uma resposta final na &aacute;rea correspondente. Ser&aacute; enviado um emal ao manifestante, a manifesta&ccedil;&atilde;o ter&aacute; seu status modificado para fechada e voc&ecirc; poder&aacute; definir um outro status qualquer na tela de manifesta&ccedil;&otilde;es fechadas. </p>
                <p class="texto">&nbsp;</p>
                <p class="texto">&nbsp;</p>
              </div></th>
