...
<table width="100%" height="163" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="29" bgcolor="#FFFFFF"><strong>&nbsp;<span class="style22">&nbsp;</span></strong><span class="subtitulo">8 Tela de Detalhes das Manifesta&ccedil;&otilde;es Fechadas </span></td>
  </tr>
  <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <th width="93%" bgcolor="#F3F8F1" scope="col"><div align="justify">
                <p class="texto">Nesta tela voc&ecirc; poder&aacute; visualizar todos os dados referente a manifesta&ccedil;&atilde;o fechada que voc&ecirc; escolheu. </p>
                ...
                <p class="texto"><img src="img_ajuda/TelaFechadasDetalhes.jpg" width="656" height="319" border="1"></p>
                ...
                <p class="texto">2 - ALTERAR STATUS - Caso deseje alterar o status da manifesta&ccedil;&atilde;o basta escolher um novo status na caixa de sele&ccedil;&atilde;o e clicar em alterar status.</p>
                <p class="texto">3 - TABELA DE DESCRI&Ccedil;&Atilde;O - Nesta tabela encontra-se as respostas dadas por cada departamento assim como a data do envio e a data da resposta. </p>
                <p class="texto">&nbsp;</p>
                <p class="texto">&nbsp;</p>
              </div></th>
