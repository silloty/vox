...
<table width="100%" height="163" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="29" bgcolor="#FFFFFF"><strong>&nbsp;<span class="style22">&nbsp;</span></strong><span class="subtitulo">9 Tela de Usu&aacute;rios - Visualiza&ccedil;&atilde;o e Cadastro </span></td>
  </tr>
  <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <th width="93%" bgcolor="#F3F8F1" scope="col"><div align="justify">
                <p class="texto">Nesta tela voc&ecirc; poder&aacute; visualizar todos os usu&aacute;rios administradores cadastrados no sistema. </p>
                <p class="texto"><img src="img_ajuda/TelaUsuarios.jpg" width="598" height="268" border="0"></p>
                <p class="texto">1 - ALTERAR - Como descrito em vermelho pressione enter sobre a op&ccedil;&atilde;o desejada para alterar algum dado do usu&aacute;rios. Voc&ecirc; ser&aacute; redirecionado para a tela da figura logo abaixo (Figura 2) </p>
                <p class="texto">2 - NOVO - Para cadastrar um usu&aacute;rio clique em novo que ser&aacute; redirecionado para a tela da figura logo abaixo(Figura 2).</p>
                <p class="texto">3 - EXCLUIR - Para excluir um usu&aacute;rio clique em excluir. O usu&aacute;rio admin n&atilde;o pode ser exclu&iacute;do </p>
                <p class="texto">4 - N&Uacute;MERO DE P&Aacute;GINAS- Neste local est&aacute; descrito a numera&ccedil;&atilde;o da p&aacute;gina em que se encontra assim como a quantidade de p&aacute;ginas existentes.</p>
                <p class="texto"><strong><em>Figura 2 (abaixo) </em></strong></p>
                <p class="texto"><img src="img_ajuda/TelaAlteracaoUsuarios.jpg" width="442" height="337"></p>
                <p class="texto">1 - DESCRI&Ccedil;&Atilde;O DA A&Ccedil;&Atilde;O - Estar&aacute; descrito a a&ccedil;&atilde;o que o usu&aacute;rio ir&aacute; realizar. Altera&ccedil;&atilde;o ou cadastro.</p>
                <p class="texto">2 - CAMPOS DA SENHA - Informe senha corretamente duas vezes para que possa efetuar a a&ccedil;&atilde;o desejada.</p>
                <p class="texto">3 - GRAVAR - Clique em gravar para efetuar a opera&ccedil;&atilde;o.</p>
                <p class="texto">4 - CANCELAR - Clique em cancelar caso n&atilde;o deseje efetuar a opera&ccedil;&atilde;o. </p>
                <p class="texto">&nbsp;</p>
              </div></th>
