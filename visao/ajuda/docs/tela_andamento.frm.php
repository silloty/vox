...
<table width="100%" height="163" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="29" bgcolor="#FFFFFF"><strong>&nbsp;<span class="style22">&nbsp;</span><span class="subtitulo">5</span></strong><span class="subtitulo"> Tela de Manifesta&ccedil;&otilde;es em Andamento </span></td>
  </tr>
  <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <th width="93%" bgcolor="#F3F8F1" scope="col"><div align="justify">
                <p class="texto">Nesta tela voc&ecirc; poder&aacute; visualizar todas as manifesta&ccedil;&otilde;es  que  j&aacute; foram encaminhadas a algum departamento. </p>
