...
<script  type="text/javascript" src="js/ajax/departamento.ajax.js"></script>
    <style type="text/css">
<!--
...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td valign="top">
            <form id="frmDepartamento" name="frmDepartamento" method="post" action="departamento.exe.php">
...
<tr>
                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;CADASTRO DE DEPARTAMENTOS  <span class="style22">(pressione ENTER sobre a op&ccedil;&atilde;o desejada para alterar)</span></b></td>
                                  </tr>
                                  <tr>
			...
			<input name="btnFiltrar" type="Button" id="btnFiltrar" onclick="Filtrar()" value="Filtrar Departamento">
											<div id="grid" height="355px" style="background-color:white;overflow:hidden"></div> 
        ...
        onclick="Dialog.alert({url: 'departamento_alteracao.frm.php?metodo=novo&codigo=', options: {method: 'get'}}, {className: 'alphacube', width:430, okLabel: 'Cancelar'});" />                                       
&nbsp;&nbsp;&nbsp;                                              </td>
...
<script> 
		...
		function doOnEnterComp(rowId)
		{
			...
			urlpassada = 'departamento_alteracao.frm.php?metodo=altera&codigo=' + codigo;
		...
		grid.setHeader("C\u00f3digo, Nome , Email, Descri\u00e7\u00e3o");
		grid.setInitWidths("70,*,200,200");
		grid.setColAlign("center, right, right, right");
		...
		grid.init();
		grid.setSkin("light");
		grid.loadXML("departamento.exe.php?metodo=carregagrid&codigo=");
...
<script>
	...
	function Filtrar()
	{
		...
		grid.init();
		grid.loadXML("departamento.exe.php?metodo=filtrar&valor="+valor+"");
