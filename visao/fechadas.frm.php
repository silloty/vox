...
<script  type="text/javascript" src="js/datagrid/dhtmlxgrid_filter.js"></script>
                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;MANIFESTA&Ccedil;&Otilde;ES FECHADAS <span class="style22">(clique em VER para visualizar detalhes da manifesta&ccedil;&atilde;o)</span></b></td>
                                  </tr>
                                  <tr>
            ...
            <!--GRID-->
                   ...
                   <!-- FIM TABELA COMPROVACAO -->
                                 <script>
											...
											grid.init();
											grid.setSkin("light");
											grid.loadXML("fechadas.exe.php?metodo=carregagrid&codigo=");
										</script>	
