...
<script  type="text/javascript" src="js/ajax/status.ajax.js"></script>
    <style type="text/css">
<!--
...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td valign="top">
            <form id="frmStatus" name="frmStatus" method="post" action="status.exe.php">
...
<tr>
                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;CADASTRO DE TIPOS DE STATUS <span class="style22">(pressione ENTER sobre a op&ccedil;&atilde;o desejada para alterar)</span></b></td>
                                  </tr>
                                  <tr>
        ...
        onclick="Dialog.alert({url: 'status_alteracao.frm.php?metodo=novo&codigo=', options: {method: 'get'}}, {className: 'alphacube', width:430, okLabel: 'Cancelar'});" />                                       
&nbsp;&nbsp;&nbsp;                                              </td>
                   ...
                   <!-- FIM TABELA COMPROVACAO -->
                                 <script>
                                        	function doOnEnterComp(rowId)
											{
										        ...
										        urlpassada = 'status_alteracao.frm.php?metodo=altera&codigo=' + codigo;
											...
											grid.setHeader("C\u00f3digo, Nome, Descri\u00e7\u00e3o");
											grid.setInitWidths("70,*,200");
											...
											grid.init();
											grid.setSkin("light");
											grid.loadXML("status.exe.php?metodo=carregagrid&codigo=");
										</script>
                    ...
                    <tr>
                        <td bgcolor="#68B92C" valign="middle" align="center" class="rodape"><span class="style23">Sistema de Ouvidoria - VOX / CEFET - Bambu&iacute;</span></td>
                  </tr>
                    <tr>
