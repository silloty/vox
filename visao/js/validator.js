...
a_messages = [
    'Nenhum nome do formulario passou a rotina do Validator',
    'Nenhum array do campo "%form%" passou a rotina do Validator',
    'O formulario "%form%" nao pode ser encontrado no documento',
    'Entrada imcompleta no campo de formulario "%n%". Atributo "l" nao encontrado',
    'Nao encontrado o campo "%n%" no formulario "%form%"',
    'Nao encontrada a label tag (id="%t%")',
    'Nao e possível validar. Campo "%m%" nao encontrado',
    '"%l%" precisa ser preenchido!',
    '"%l%" precisa no minimo %mn% caracteres ou mais',
    '"%l%" precisa ter mais que %mx% caracteres',
    '"%v%": valor inválido para "%l%"',
    '"%l%" deve ser "%ml%"'
]
