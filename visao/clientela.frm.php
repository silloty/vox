...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td valign="top">
            <form id="frmClientela" name="frmClientela" method="post" action="clientela.exe.php">
...
<tr>
                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;CADASTRO DE TIPOS DE CLIENTELA <span class="style22">(pressione ENTER sobre a op&ccedil;&atilde;o desejada para alterar)</span></b></td>
                                  </tr>
                                  <tr>
        ...
        onclick="Dialog.alert({url: 'clientela_alteracao.frm.php?metodo=novo&codigo=', options: {method: 'get'}}, {className: 'alphacube', width:430, okLabel: 'Cancelar'});" />                                       
&nbsp;&nbsp;&nbsp;                                              </td>
                   ...
                   <!-- FIM TABELA COMPROVACAO -->
                                 <script>
                                        	function doOnEnterComp(rowId)
											{
										        ...
										        urlpassada = 'clientela_alteracao.frm.php?metodo=altera&codigo=' + codigo;
											...
											grid.setHeader("C\u00f3digo, Nome");
											grid.setInitWidths("70,*");
											grid.setColAlign("center, right");
											...
											grid.init();
											grid.setSkin("light");
											grid.loadXML("clientela.exe.php?metodo=carregagrid&codigo=");
										</script>
