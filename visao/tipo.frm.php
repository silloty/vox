...
<body>
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td valign="top">
            <form id="frmTipo" name="frmTipo" method="post" action="tipo.exe.php">
...
<tr>
                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;CADASTRO DE TIPOS DE MANIFESTA&Ccedil;&Otilde;ES <span class="style22">(pressione ENTER sobre a op&ccedil;&atilde;o desejada para alterar)</span></b></td>
                                  </tr>
                                  <tr>
        ...
        onclick="Dialog.alert({url: 'tipo_alteracao.frm.php?metodo=novo&codigo=', options: {method: 'get'}}, {className: 'alphacube', width:430, okLabel: 'Cancelar'});" />                                       
&nbsp;&nbsp;&nbsp;                                              </td>
                   ...
                   <!-- FIM TABELA COMPROVACAO -->
                                 <script>
                                        	function doOnEnterComp(rowId)
											{
										        ...
										        urlpassada = 'tipo_alteracao.frm.php?metodo=altera&codigo=' + codigo;
											...
											grid.setHeader("C\u00f3digo, Nome, Visivel ao manifestante");
											grid.setInitWidths("70,*,160");
											grid.setColAlign("center, right, center");
											...
											grid.init();
											grid.setSkin("light");
											grid.loadXML("tipo.exe.php?metodo=carregagrid&codigo=");
										</script>
