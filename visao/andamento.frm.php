                    ...
                    <tr>
                        <td>
                                ...
                                <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td  height="36"><b>&nbsp;&nbsp;&nbsp;MANIFESTA&Ccedil;&Otilde;ES EM ANDAMENTO <span class="style22">(clique em VER para visualizar detalhes da manifesta&ccedil;&atilde;o)</span></b></td>
                                  </tr>
                                  <tr>
                                        <td>
			...
			&nbsp;por:<input type="radio" name="txtTipoFiltro" id="txtTipoFiltro" value="nome">Nome<input type="radio" id="txtTipoFiltro" name="txtTipoFiltro" value="assunto" checked="checked">Assunto	
                   ...
                   <!-- FIM TABELA COMPROVACAO -->
                                 <script>
											...
											grid.init();
											grid.setSkin("light");
											grid.loadXML("andamento.exe.php?metodo=carregagrid&codigo=");
										</script>
                        				<script>
											...
											function Filtrar()
											{
												...
												grid.init();
												grid.loadXML("andamento.exe.php?metodo=filtrar&valor="+valor+"&tipo_filtro="+tipo_filtro);
