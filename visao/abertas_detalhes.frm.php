                                ...
                                <tr>
                                    ...
                                    <td ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="75%">&nbsp;<a href="abertas.frm.php"><b>VOLTAR</b></a></td>
                                      </tr>
                                    </table></td><td >&nbsp;&nbsp;&nbsp;</td>
                              <td valign="middle">
					...
					if(trim($manifestacao->GetIdentificacao()) == 'S')
					{
						...
						'
                          ...
                          <tr>
                            ...
                            <td><div align="center">
                              <label>
                              <input name="btnSalvar" type="button" class="botaoA" id="btnSalvar" value="Salvar Alterações" onClick="submitForm(\'frmDetalhes\',\'salvar\','.$manifestacao->GetCodigo().');"/>
                              </label>
                            </div></td>
                          </tr>
                          <tr>
                            ...
                            <td rowspan="5" valign="bottom"><div align="center">
  ...
  <tr>
    <td><div align="center">
      <input name="btnEncaminhar" type="button" class="botaoA" id="btnEncaminhar" value="Encaminhar"  onclick="submitForm(\'frmDetalhes\',\'encaminhar\','.$manifestacao->GetCodigo().');"/>
                              ...
                              <p><img src="imagens/finalizar.png" width="70" height="70" /></p>
                              <p>
                                <input name="btnFinalizar" type="button" class="botaoA" id="btnFinalizar" value="Finalizar"  onclick="submitForm(\'frmDetalhes\',\'finalizar\','.$manifestacao->GetCodigo().');"/>
                                <br>
                                </p>
                            </div></td>
                          </tr>
                          ...
                          <tr>
							...
							<img src="imagens/info.png" alt="" width="17" height="17" onmouseover="Tip(\'Legenda de Cores <br> Verde - Respondida <br> Amarelo - Aguardando resposta <br> Vermelho - Aguardando há mais de 05 dias\', BGCOLOR, \'#FFFFFF\')" onmouseout="UnTip()" />							</td>
  </tr>
                          <tr>
                            <td><strong>Departamento: </strong></td>
                            <td><label>
                              <select name="dpdDepartamentos" id="dpdDepartamentos" style="width:400px" value="">
  ...
  <tr>
    <td><div align="center">
      <input name="btnEncaminhar" type="button" class="botaoA" id="btnEncaminhar" value="Encaminhar"  onclick="submitForm(\'frmDetalhes\',\'encaminhar\','.$manifestacao->GetCodigo().');"/>
                              ...
                              <table width="100%" border="0">
                                <tr>
                                  <th scope="col"><img src="imagens/finalizar.png" width="70" height="70" /></th></tr>
                              </table>
                              <input name="btnFinalizar" type="button" class="botaoA" id="btnFinalizar" value="Finalizar"  onclick="submitForm(\'frmDetalhes\',\'finalizar\','.$manifestacao->GetCodigo().');"/>
                              </p><br>
                            </div></td>
